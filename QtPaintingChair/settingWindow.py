...
class Ui_motorSettings(object):
    def setupUi(self, motorSettings):
        ...
        motorSettings.resize(873, 459)
        motorSettings.setMinimumSize(QtCore.QSize(873, 459))
        motorSettings.setMaximumSize(QtCore.QSize(873, 459))
        icon = QtGui.QIcon()
        ...
        self.frame2.setGeometry(QtCore.QRect(0, 0, 871, 501))
...
"border-radius: 5px")
        ...
        self.buttonBox.setGeometry(QtCore.QRect(670, 400, 193, 50))
