...
class checkComWindow():
    def __init__(self):
        ...
        uiWorking.actionConnect_to_Slave.triggered.connect(self.showComWindow)
    ...
    def choose_comports(self):
        ...
        result = workSerial.choose_comports(115200,com)
        if result: 
...
class paramWindow:
    def __init__(self):
        ...
        uiWorking.pushButton_settings.clicked.connect(self.showParamWindow)
        uiWorking.actionMotor.triggered.connect(self.showParamWindow)
...
class teachingWindow:
    def __init__(self):
        ...
        uiWorking.actionTeach_mode_3.triggered.connect(control.enterTeachMode)
    ...
    def defineTeachModeButton(self):
        ...
        for i in range(len(self.teachModeButton_coil)): 
            self.teachModeButton_coil[i].clicked.connect(teachModeButtonFwCommand[i])
    ...
    def initTeachMode(self):
        main_window.showStatus("===> Enter teach mode")
    ...
    def Kinematics_Zaxis_mode_02(self):
            if self.chooseAxis == self.z1AXIS:
                ...
                while True:
                    ...
                    if (self.monitor_off == True) or (self.chooseAxis != self.zAXIS):
                        break
            else: pass
#================================================================================================
class controlButton():
    ...
    def defineControlButton(self):
        self.controlButtonName = [uiWorking.pushButton_choosefile, uiWorking.pushButton_teach, 
                                   uiWorking.pushButton_manual, uiWorking.pushButton_gotozero, uiWorking.pushButton_machinehome]
        self.controlButtonCommand = [self.chooseFile, self.enterTeachMode,  self.enterManual, 
